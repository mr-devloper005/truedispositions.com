        ...
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[var(--editable-container)] items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
          <div>
            ...
            <div className="mt-8 grid max-w-lg gap-3 sm:grid-cols-3">
              {['Saved uploads', 'PDF submissions', 'Library access'].map((item) => <span key={item} className="rounded-2xl border border-[var(--editable-border)] bg-white px-4 py-3 text-xs font-black uppercase tracking-[0.14em] text-[var(--slot4-soft-muted-text)]">{item}</span>)}
            </div>
          </div>
          <div className="rounded-[2rem] border border-[var(--editable-border)] bg-white/80 p-6 shadow-[0_24px_70px_rgba(17,46,129,0.12)] backdrop-blur sm:p-8">
